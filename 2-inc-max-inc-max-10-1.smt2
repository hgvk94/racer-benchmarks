...
(assert (forall ((_1 Int) (_2 ~Mut<Int>) (_3 ~Mut<Int>))
  (=> (and (%inc_max_repeat.0 _1 _2 _3 (= _1 0))) (%inc_max_repeat _1 _2 _3))))
(assert (forall ((_1 Int)
         ...
         (_*.4_10 Int)
         (_*.4_12 Int))
  (let ((a!1 (and (%take_max (~mut<Int> (~cur<Int> _2) _*.1_3)
                             (~mut<Int> (~cur<Int> _3) _*.1_5)
                             _@.1)
                  (%inc_max_repeat (- _1 1)
                                   (~mut<Int> _*.1_3 _*.4_10)
                                   (~mut<Int> _*.1_5 _*.4_12))
                  (= (~ret<Int> _@.1) (+ (~cur<Int> _@.1) 1))
                  (= (~ret<Int> _3) _*.4_12)
                  (= (~ret<Int> _2) _*.4_10)
                  true)))
    (=> a!1 (%inc_max_repeat.0 _1 _2 _3 false)))))
(assert (forall ((_1 Int) (_2 ~Mut<Int>) (_3 ~Mut<Int>))
...
(assert (forall ((_! Bool)
         ...
         (_*.3_9 Int)
         (_*.3_10 Int))
  (let ((a!1 (and (%inc_max_repeat _?.0
                                   (~mut<Int> _?.1 _*.3_6)
                                   (~mut<Int> _?.2 _*.3_10))
                  (= _*.3_9 _*.3_10)
                  (= _*.3_5 _*.3_6)
                  (%main.4 _?.0 _*.3_5 _*.3_9 (> (- _*.3_5 _*.3_9) _?.0) _!))))
    (=> a!1 (%main _!)))))
(assert (forall ((_1 Int) (_2 Int) (_3 Int) (_! Bool))
  (let ((a!1 (and (%main.7 _1 _2 _3 false (> (- _3 _2) _1) _!))))
    (=> a!1 (%main.4 _1 _2 _3 false _!)))))
(assert (forall ((_1 Int) (_2 Int) (_3 Int) (_! Bool))
  (=> (and (%main.8 (not true) _!)) (%main.4 _1 _2 _3 true _!))))
(assert (forall ((_1 Int) (_2 Int) (_3 Int) (_12 Bool) (_! Bool))
  (=> (and (%main.8 (not false) _!)) (%main.7 _1 _2 _3 _12 false _!))))
(assert (forall ((_1 Int) (_2 Int) (_3 Int) (_12 Bool) (_! Bool))
  (=> (and (%main.8 (not true) _!)) (%main.7 _1 _2 _3 _12 true _!))))
