...
(declare-fun pushback-abs ((List Int) (List Int) Int Int Int) Bool)
...
(assert (forall ((x Int) (c!0 Int) (c!1 Int))
  (let ((a!1 (and (= ((_ sum 0) nil) c!0)
                  (sum nil c!0)
                  (= ((_ sum 0) (insert x nil)) c!1)
                  (sum (insert x nil) c!1)
                  true)))
    (=> a!1 (pushback-abs nil (insert x nil) x c!0 c!1)))))
(assert (forall ((y Int)
         (xs! (List Int))
         (xs (List Int))
         (x Int)
  ...
  (let ((a!1 (and (= ((_ sum 0) (insert x xs)) c!2)
                  ...
                  (= ((_ sum 0) xs!) c!5)
                  (sum xs! c!5)
                  (pushback-abs xs xs! y c!4 c!5))))
    (=> a!1 (pushback-abs (insert x xs) (insert x xs!) y c!2 c!3)))))
