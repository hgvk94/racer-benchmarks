...
(declare-fun %main.46 (Bool Bool) Bool)
(assert (forall ((_1 Bool)) (=> (and (%assume.0 _1 (not _1))) (%assume _1))))
(assert (forall ((_1 Bool)) (=> (and true) (%assume.0 _1 false))))
(assert (forall ((_1 Bool)) (=> (and false) (%assume.0 _1 true))))
...
(assert (forall ((_1 Int) (_2 Int) (_3 Int) (_7 Int) (_! Bool) (_?.10 Bool))
  (=> (and (%main.11 _1 _2 _3 0 _7 _?.10 _!)) (%main.6 _1 _2 _3 _7 false _!))))
(assert (forall ((_1 Int) (_2 Int) (_3 Int) (_7 Int) (_! Bool) (_?.10 Bool))
  (=> (and (%main.11 _1 _2 _3 1 _7 _?.10 _!)) (%main.6 _1 _2 _3 _7 true _!))))
...
(assert (forall ((_1 Int)
         ...
         (_7 Int)
         (_! Bool))
  (let ((a!1 (and (%main.28 _1 _2 _3 _4 _5 _6 _7 (not (= _4 0)) _!))))
    (=> a!1 (%main.27 _1 _2 _3 _4 _5 _6 _7 false _!)))))
(assert (forall ((_1 Int)
         (_2 Int)
         (_3 Int)
         (_4 Int)
...
(assert (forall ((_1 Int)
         ...
         (_7 Int)
         (_! Bool))
  (let ((a!1 (and (%main.35 _1 _2 _3 _4 _5 _6 _7 (not (= _5 0)) _!))))
    (=> a!1 (%main.34 _1 _2 _3 _4 _5 _6 _7 false _!)))))
(assert (forall ((_1 Int)
         (_2 Int)
         (_3 Int)
         (_4 Int)
...
(assert (forall ((_1 Int)
         ...
         (_7 Int)
         (_! Bool))
  (let ((a!1 (and (%main.42 _1 _2 _3 _4 _5 _6 _7 (not (= _6 0)) _!))))
    (=> a!1 (%main.41 _1 _2 _3 _4 _5 _6 _7 false _!)))))
(assert (forall ((_1 Int)
         (_2 Int)
         (_3 Int)
         (_4 Int)
...
(assert (forall ((_1 Int)
         ...
         (_7 Int)
         (_! Bool))
  (let ((a!1 (and (%main.46 (not (> _7 0)) _!))))
    (=> a!1 (%main.42 _1 _2 _3 _4 _5 _6 _7 false _!)))))
(assert (forall ((_1 Int)
         (_2 Int)
         (_3 Int)
         (_4 Int)
         ...
         (_! Bool))
  (let ((a!1 (and (%main.46 (not (> _7 0)) _!))))
    (=> a!1 (%main.42 _1 _2 _3 _4 _5 _6 _7 true _!)))))
(assert (forall ((_! Bool)) (=> (and (= _! false)) (%main.46 false _!))))
(assert (forall ((_! Bool)) (=> (and (= _! true)) (%main.46 true _!))))
