...
(declare-fun append-abs ((List Int) (List Int) (List Int) Int Int Int) Bool)
...
(assert (forall ((xs (List Int)) (c!0 Int) (c!1 Int) (c!2 Int))
  (=> (and (= ((_ sum 0) nil) c!0)
           ...
           (sum xs c!2)
           true)
      (append-abs nil xs xs c!0 c!1 c!2))))
(assert (forall ((ys (List Int))
         ...
         (c!7 Int)
         (c!8 Int))
  (let ((a!1 (and (= ((_ sum 0) (insert x xs)) c!3)
                  (sum (insert x xs) c!3)
                  ...
                  (= ((_ sum 0) ys) c!8)
                  (sum ys c!8)
                  (append-abs xs xs! ys c!6 c!7 c!8))))
    (=> a!1 (append-abs (insert x xs) (insert x xs!) ys c!3 c!4 c!5)))))
...
(assert (forall ((n Int)
  ...
  (=> (and (= ((_ sum 0) xs) c!9)
           ...
           (sum xs n)
           (sum ys m)
           (append-abs xs xs! ys c!9 c!10 c!11)
           (sum xs! r)
           (= ((_ sum 0) xs) n)
           (= ((_ sum 0) ys) m)
           (= ((_ sum 0) xs!) r))
