...
(declare-fun inc-abs ((Mut (List Int)) Int Int Int Int) Bool)
...
(assert (forall ((dummy Int) (c!0 Int) (c!1 Int) (c!2 Int) (c!3 Int))
  (=> (and (= ((_ sum 0) nil) c!0)
           (sum nil c!0)
           (= ((_ sum 0) nil) c!1)
           (sum nil c!1)
           ...
           (length nil c!3)
           true)
      (inc-abs (mut nil nil) c!0 c!1 c!2 c!3))))
(assert (forall ((xs! (List Int))
         ...
         (c!10 Int)
         (c!11 Int))
  (let ((a!1 (= ((_ sum 0) (insert (+ 1 x) xs!)) c!5))
        (a!2 (= ((_ length 0) (insert (+ 1 x) xs!)) c!7))
        (a!4 (inc-abs (mut (insert x xs) (insert (+ x 1) xs!)) c!4 c!5 c!6 c!7)))
  (let ((a!3 (and (= ((_ sum 0) (insert x xs)) c!4)
                  (sum (insert x xs) c!4)
                  a!1
                  (sum (insert (+ 1 x) xs!) c!5)
                  (= ((_ length 0) (insert x xs)) c!6)
                  (length (insert x xs) c!6)
                  a!2
                  (length (insert (+ 1 x) xs!) c!7)
                  (= ((_ sum 0) xs) c!8)
                  (sum xs c!8)
                  (= ((_ sum 0) xs!) c!9)
                  (sum xs! c!9)
                  ...
                  (= ((_ length 0) xs!) c!11)
                  (length xs! c!11)
                  (inc-abs (mut xs xs!) c!8 c!9 c!10 c!11))))
    (=> a!3 a!4)))))
...
(assert (forall ((xs! (List Int))
  ...
  (=> (and (= ((_ sum 0) xs) c!12)
           ...
           (sum xs n)
           (length xs l)
           (inc-abs (mut xs xs!) c!12 c!13 c!14 c!15)
           (sum xs! r)
           (= ((_ sum 0) xs) n)
           (= ((_ sum 0) xs!) r)
           (= ((_ length 0) xs) l))
