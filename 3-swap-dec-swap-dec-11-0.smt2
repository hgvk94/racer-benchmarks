...
(declare-fun %main.5
             (Int Int Int Int Int ~Mut<Int> ~Mut<Int> ~Mut<Int> Bool Bool)
             Bool)
(declare-fun %swap_dec_bound_three
             (Int ~Mut<~Mut<Int>> ~Mut<~Mut<Int>> ~Mut<~Mut<Int>>)
             Bool)
(declare-fun %main.9 (Bool Bool) Bool)
(declare-fun %main.8
             (Int Int Int Int Int ~Mut<Int> ~Mut<Int> ~Mut<Int> Bool Bool Bool)
             Bool)
...
(declare-fun %swap_dec_bound_three.3
             (Int ~Mut<~Mut<Int>> ~Mut<~Mut<Int>> ~Mut<~Mut<Int>> Bool)
             Bool)
(assert (forall ((_! Bool)
         ...
         (_*.4_21 ~Mut<Int>)
         (_*.4_22 ~Mut<Int>))
  (let ((a!1 (and (%swap_dec_bound_three
                    _?.0
                    (~mut<~Mut<Int>> (~mut<Int> _?.1 _*.4_3) _*.4_14)
                    (~mut<~Mut<Int>> (~mut<Int> _?.2 _*.4_5) _*.4_18)
                    (~mut<~Mut<Int>> (~mut<Int> _?.3 _*.4_7) _*.4_22))
                  (= _*.4_21 _*.4_22)
                  (= _*.4_17 _*.4_18)
                  (= _*.4_13 _*.4_14)
                  (%main.5 _?.0
...
(assert (forall ((_1 Int)
         ...
         (_8 ~Mut<Int>)
         (_! Bool))
  (=> (and (= (~ret<Int> _6) (~cur<Int> _6))
           (= (~ret<Int> _7) (~cur<Int> _7))
           (= (~ret<Int> _8) (~cur<Int> _8))
           (%main.9 (not false) _!))
...
(assert (forall ((_1 Int)
  ...
  (let ((a!1 (and (%main.8 _1
                           ...
                           (<= (- _5 _2) (* 3 _1))
                           _!))))
    (=> a!1 (%main.5 _1 _2 _3 _4 _5 _6 _7 _8 true _!)))))
(assert (forall ((_1 Int)
         (_2 Int)
         (_3 Int)
         (_4 Int)
...
(assert (forall ((_1 Int)
  ...
  (let ((a!1 (and (%may_swap<~Mut<Int>>
                  ...
                  (%may_swap<~Mut<Int>>
                    (~mut<~Mut<Int>> _*.0_4 _*.1_5)
                    (~mut<~Mut<Int>> (~cur<~Mut<Int>> _4) _*.1_7))
                  (%may_swap<~Mut<Int>>
                    (~mut<~Mut<Int>> _*.0_2 _*.2_5)
                    (~mut<~Mut<Int>> _*.1_5 _*.2_7))
                  (%swap_dec_bound_three.3
                    _1
                    (~mut<~Mut<Int>> _*.2_5 (~ret<~Mut<Int>> _2))
                    (~mut<~Mut<Int>> _*.2_7 (~ret<~Mut<Int>> _3))
                    (~mut<~Mut<Int>> _*.1_7 (~ret<~Mut<Int>> _4))
                    (= _1 0)))))
    (=> a!1 (%swap_dec_bound_three _1 _2 _3 _4)))))
(assert (forall ((_1 Int)
         (_2 ~Mut<~Mut<Int>>)
         (_3 ~Mut<~Mut<Int>>)
         (_4 ~Mut<~Mut<Int>>)
  ...
  (let ((a!1 (~mut<Int> (- (~cur<Int> (~cur<~Mut<Int>> _2)) 1)
        ...
        (a!3 (~mut<Int> (- (~cur<Int> (~cur<~Mut<Int>> _4)) 3)
                        (~ret<Int> (~cur<~Mut<Int>> _4)))))
    (=> (and (%swap_dec_bound_three
               (- _1 1)
               (~mut<~Mut<Int>> a!1 _*.4_11)
               (~mut<~Mut<Int>> a!2 _*.4_13)
               (~mut<~Mut<Int>> a!3 _*.4_15))
             (= (~ret<~Mut<Int>> _4) _*.4_15)
             (= (~ret<~Mut<Int>> _3) _*.4_13)
             (= (~ret<~Mut<Int>> _2) _*.4_11)
             true)
...
(assert (forall ((_1 Int)
         ...
         (_3 ~Mut<~Mut<Int>>)
         (_4 ~Mut<~Mut<Int>>))
  (=> (and (= (~ret<~Mut<Int>> _4) (~cur<~Mut<Int>> _4))
