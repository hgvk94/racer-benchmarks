...
(declare-fun %linger_dec_three.6
             (~Mut<Int>
              ~Mut<Int>
              ~Mut<Int>
              Int
              ...
              Bool)
             Bool)
(declare-fun %linger_dec_three.9
             (~Mut<Int>
              ~Mut<Int>
              ~Mut<Int>
              Int
              ...
              Bool)
             Bool)
(declare-fun %linger_dec_three.12
             (~Mut<Int>
              ~Mut<Int>
              ~Mut<Int>
              Int
...
(assert (forall ((_1 ~Mut<Int>) (_2 ~Mut<Int>) (_3 ~Mut<Int>) (_?.0 Bool))
  (let ((a!1 (%linger_dec_three.1
               (~mut<Int> (- (~cur<Int> _1) 1) (~ret<Int> _1))
               (~mut<Int> (- (~cur<Int> _2) 2) (~ret<Int> _2))
               (~mut<Int> (- (~cur<Int> _3) 3) (~ret<Int> _3))
               _?.0)))
    (=> (and a!1) (%linger_dec_three _1 _2 _3)))))
...
(assert (forall ((_1 ~Mut<Int>)
         ...
         (_*.16_5 Int)
         (_*.16_7 Int))
  (let ((a!1 (and (= (~ret<Int> _6) (~cur<Int> _6))
                  (= _*.8_2 _*.8_3)
                  (%linger_dec_three
                    (~mut<Int> _5 _*.16_3)
                    (~mut<Int> (~cur<Int> _7) _*.16_5)
                    (~mut<Int> (~cur<Int> _8) _*.16_7))
                  (= (~ret<Int> _8) _*.16_7)
                  (= (~ret<Int> _7) _*.16_5)
                  (= _*.8_3 _*.16_3)
                  (= (~ret<Int> _1) (~cur<Int> _1))
                  ...
                  (= (~ret<Int> _3) (~cur<Int> _3))
                  true)))
    (=> a!1 (%linger_dec_three.6 _1 _2 _3 _5 _6 _7 _8 true)))))
(assert (forall ((_1 ~Mut<Int>)
         (_2 ~Mut<Int>)
         (_3 ~Mut<Int>)
         (_5 Int)
...
(assert (forall ((_1 ~Mut<Int>)
         ...
         (_*.16_5 Int)
         (_*.16_7 Int))
  (let ((a!1 (and (= (~ret<Int> _7) (~cur<Int> _7))
                  (= _*.11_2 _*.11_3)
                  (%linger_dec_three
                    (~mut<Int> (~cur<Int> _6) _*.16_3)
                    (~mut<Int> _5 _*.16_5)
                    (~mut<Int> (~cur<Int> _8) _*.16_7))
                  (= (~ret<Int> _8) _*.16_7)
                  (= _*.11_3 _*.16_5)
                  ...
                  (= (~ret<Int> _3) (~cur<Int> _3))
                  true)))
    (=> a!1 (%linger_dec_three.9 _1 _2 _3 _5 _6 _7 _8 _9 true)))))
(assert (forall ((_1 ~Mut<Int>)
         (_2 ~Mut<Int>)
         (_3 ~Mut<Int>)
         (_5 Int)
  ...
  (let ((a!1 (and (%linger_dec_three
                  ...
                  (= (~ret<Int> _2) (~cur<Int> _2))
                  true)))
    (=> a!1 (%linger_dec_three.12 _1 _2 _3 _5 _6 _7 _8 _9 _12 false)))))
(assert (forall ((_1 ~Mut<Int>)
         (_2 ~Mut<Int>)
         (_3 ~Mut<Int>)
         (_5 Int)
  ...
  (let ((a!1 (and (= (~ret<Int> _8) (~cur<Int> _8))
                  ...
                  (= (~ret<Int> _2) (~cur<Int> _2))
                  true)))
    (=> a!1 (%linger_dec_three.12 _1 _2 _3 _5 _6 _7 _8 _9 _12 true)))))
(assert (forall ((_! Bool)
         ...
         (_*.3_13 Int)
         (_*.3_14 Int))
  (let ((a!1 (%main.4 (not (> (- _?.0 1) _*.3_5)) _!)))
    (=> (and (%linger_dec_three
               (~mut<Int> _?.0 _*.3_6)
               (~mut<Int> _?.1 _*.3_10)
               (~mut<Int> _?.2 _*.3_14))
             (= _*.3_13 _*.3_14)
