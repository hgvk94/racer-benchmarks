...
(declare-datatypes ((Mut 1)) ((par (k!00)((mut (cur k!00) (ret k!00))))))
(declare-fun some-abs ((Mut (Tree Int)) (Mut Int) Int Int) Bool)
...
(assert (forall ((txr (Tree Int)) (x! Int) (x Int) (txl (Tree Int)) (c!0 Int) (c!1 Int))
  (let ((a!1 (and (= ((_ sum 0) (node txl x txr)) c!0)
                  ...
                  true)))
    (=> a!1
        (some-abs (mut (node txl x txr) (node txl x! txr)) (mut x x!) c!0 c!1)))))
(assert (forall ((mr (Mut Int))
  ...
  (let ((a!1 (and (= ((_ sum 0) (node txl x txr)) c!2)
                  ...
                  (= ((_ sum 0) txl!) c!5)
                  (sum txl! c!5)
                  (some-abs (mut txl txl!) mr c!4 c!5))))
    (=> a!1 (some-abs (mut (node txl x txr) (node txl! x txr)) mr c!2 c!3)))))
(assert (forall ((mr (Mut Int))
         (txr! (Tree Int))
         (txr (Tree Int))
         (x Int)
  ...
  (let ((a!1 (and (= ((_ sum 0) (node txl x txr)) c!6)
                  ...
                  (= ((_ sum 0) txr!) c!9)
                  (sum txr! c!9)
                  (some-abs (mut txr txr!) mr c!8 c!9))))
    (=> a!1 (some-abs (mut (node txl x txr) (node txl x txr!)) mr c!6 c!7)))))
...
(assert (forall ((n Int)
  ...
  (=> (and (= ((_ sum 0) tx) c!10)
           ...
           (sum tx! c!11)
           (sum tx n)
           (some-abs (mut tx tx!) (mut y y!) c!10 c!11)
           (sum tx! r)
           (= ((_ sum 0) tx) n)
           (= ((_ sum 0) tx!) r)
           (= y! (+ y k)))
