...
(declare-fun inck-abs ((Mut (List Int)) Int Int Int Int Int) Bool)
...
(assert (forall ((k Int) (c!0 Int) (c!1 Int) (c!2 Int) (c!3 Int))
  (=> (and (= ((_ sum 0) nil) c!0)
           ...
           (length nil c!3)
           true)
      (inck-abs (mut nil nil) k c!0 c!1 c!2 c!3))))
(assert (forall ((xs! (List Int))
         ...
         (c!10 Int)
         (c!11 Int))
  (let ((a!1 (= ((_ sum 0) (insert (+ x k) xs!)) c!5))
        (a!2 (= ((_ length 0) (insert (+ x k) xs!)) c!7))
        (a!4 (inck-abs (mut (insert x xs) (insert (+ x k) xs!))
                       k
                       c!4
                       c!5
                       c!6
  ...
  (let ((a!3 (and (= ((_ sum 0) (insert x xs)) c!4)
                  ...
                  (= ((_ length 0) xs!) c!11)
                  (length xs! c!11)
                  (inck-abs (mut xs xs!) k c!8 c!9 c!10 c!11))))
    (=> a!3 a!4)))))
...
(assert (forall ((xs! (List Int))
  ...
  (=> (and (= ((_ sum 0) xs) c!12)
           ...
           (sum xs n)
           (length xs l)
           (inck-abs (mut xs xs!) k c!12 c!13 c!14 c!15)
           (sum xs! r)
           (= ((_ sum 0) xs) n)
           (= ((_ sum 0) xs!) r)
           (= ((_ length 0) xs) l))
