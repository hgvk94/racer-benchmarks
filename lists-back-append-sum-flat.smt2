...
(declare-fun back-abs
             ((List Int) (List Int) (List Int) (List Int) Int Int Int Int)
             Bool)
...
(assert (forall ((xs (List Int)) (c!0 Int) (c!1 Int) (c!2 Int) (c!3 Int))
  (=> (and (= ((_ sum 0) nil) c!0)
           ...
           (sum xs c!3)
           true)
      (back-abs nil xs nil xs c!0 c!1 c!2 c!3))))
(assert (forall ((rs! (List Int))
  ...
  (let ((a!1 (and (= ((_ sum 0) (insert x xs)) c!4)
                  ...
                  (= ((_ sum 0) rs!) c!11)
                  (sum rs! c!11)
                  (back-abs xs xs! rs rs! c!8 c!9 c!10 c!11))))
    (=> a!1 (back-abs (insert x xs) (insert x xs!) rs rs! c!4 c!5 c!6 c!7)))))
...
(assert (forall ((n Int)
  ...
  (=> (and (= ((_ sum 0) xs) c!12)
           ...
           (= ((_ sum 0) zs!) c!15)
           (sum zs! c!15)
           (back-abs xs xs! zs zs! c!12 c!13 c!14 c!15)
           (sum xs n)
           (sum ys m)
           (sum xs! r)
           (= ((_ sum 0) xs) n)
